...
interface AdminAuctionDetailsClientProps {
    initialAuction: any
}

export function AdminAuctionDetailsClient({ initialAuction }: AdminAuctionDetailsClientProps) {
                            ...
                            <TableBody>
                                {(auction.bids || []).map((bid: any) => (
                                    <TableRow key={bid.id}>
                                        ...
                                        <TableCell className="font-mono text-xs">{bid.bidder_id} (Admin View)</TableCell>
