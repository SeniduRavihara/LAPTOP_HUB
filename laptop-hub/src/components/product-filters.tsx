      ...
      <div className="border-b border-border py-4">
        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-2">
            <input type="number" placeholder="Min" className="flex-1 px-3 py-2 border border-border rounded-lg text-sm" />
            <span className="text-muted-foreground py-2">-</span>
            <input type="number" placeholder="Max" className="flex-1 px-3 py-2 border border-border rounded-lg text-sm" />
          </div>
        </div>
      </div>
